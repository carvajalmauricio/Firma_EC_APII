...
// Imports para MultiPart (NUEVOS)
import org.glassfish.jersey.media.multipart.FormDataParam;
import org.glassfish.jersey.media.multipart.FormDataContentDisposition;

// Imports para File handling (NUEVOS)
import java.io.File;
...
public class firmarpdf {
    ...
    public SalidasFirmarpdf getDatos(EntradasFirmarpdf datos) throws KeyStoreException, Exception{
        ...
        if(comprobar.Invocador(entradas.getDocumentopdf(), entradas.getArchivop12(), 
                              entradas.getContrasena(), entradas.getPagina(), 
                              entradas.getH(), entradas.getV()) == false){
            salida = null;
        } else {
            salida = firmar;
        }
